...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Explorer" },
    { name: "Check out country data!", content: "Welcome to Explorer!" },
  ];
}

export default function Home() {
  return (
    <div className="px-2 py-32 bg-white md:px-0 block max-h-screen">
          ...
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                ...
                <span className="block text-indigo-600 xl:inline pl-3">
                  Real-Time Data
                </span>
              </h1>
